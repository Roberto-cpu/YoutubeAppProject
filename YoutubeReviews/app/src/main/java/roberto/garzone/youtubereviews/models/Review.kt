 ...
 * @param rt : String
 */
class Review(id : String, creator : String, title : String, text : String, songRef : String, rt : String) : java.io.Serializable {
     ...
     */
    fun getRating() : String { return this.mRating }

    fun setRating(newRating : String) { this.mRating = newRating }
